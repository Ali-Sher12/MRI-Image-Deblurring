...
max_shift_min = 0.1
max_shift_max = 0.3
sigma_min = 0.02 # for rican noise
sigma_max = 0.05
save_as_volume = 0
save_images = 0
...
save_as_volume = int(input("\nSave files as entire volume(1 for yes, 0 for no) - Press 0 if crashes are frequent : "))
if save_as_volume == 0:
    save_images = int(input("\nSave files as images too(1 for yes, 0 for no) : "))
print("\n")
    ...
    for folderName in folderList:
        for filename in os.listdir(folderName):
            ...
            for slice in VoxelCluster:
                if save_as_volume == 0 and save_images == 1:
                ...
                VoxelCluster[slice_index] = tamperedSlice
                ...
                slice_index+=1
            if save_as_volume == 1:    
                np.save(folderName +"/blurred_" + name + ".npy", VoxelCluster)
